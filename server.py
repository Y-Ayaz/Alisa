...
cities = {
    'москва': ['213044/12d7c3052e4547e4ba5f', '1030494/d2494f73fbe4f2c5d0c4'],
    'нью-йорк': ['1533899/7d14c373910c32826b13', '937455/930b7cbddd806ce71e77'],
    'париж': ["997614/a787255148358e837532", '1540737/a4977fe2a80d82a1f9b9']
}
...
def handle_dialog(res, req):
    ...
    if sessionStorage[user_id]['first_name'] is None:
        ...
        if first_name is None:
            ...
            res['response']['text'] = f'Приятно познакомиться, {first_name.title()}. Отгадаешь город по фото?'
